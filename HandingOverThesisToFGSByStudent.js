...
function formHandingOverThesisToFGSByStudent(dsp) {
		str = "";
		title = "Handing Over Thesis To FGS By Student";

		if(dsp == "formHandingOverThesisToFGSByStudent") { 
			
			
			
			str  = "<div id='formHandingOverThesisToFGSByStudent'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formHandingOverThesisToFGSByStudent">';
			...
			str +="<div class='viewArea' style='clear:none;' id='studentNo' >"+dataRep["studentName"]+"</div>";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Supervisor 1</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			
			str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Supervisor 2</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			
			str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Supervisor 3</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>Thesis Received Date</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			...
			str +=OneChecked;
			str +=" onclick='dataRep[this.name]=this.value;' /><label>Acknowledge Letter Issue to Student With Date</label>";
			...
			str += '<input type="button" class="btn" value = "Delete" onclick = showMenu('+"' '"+');>';
