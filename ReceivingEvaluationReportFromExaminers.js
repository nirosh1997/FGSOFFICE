...
function formReceivingEvaluationReportFromExaminers(dsp) {
		str = "";
		title = "Receiving Evaluation Report From Examiners";

		if(dsp == "formReceivingEvaluationReportFromExaminers") { 
			
			
			
			str  = "<div id='formReceivingEvaluationReportFromExaminers'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formReceivingEvaluationReportFromExaminers">';
			...
			str +="<fieldset class='field'><legend class='fieldHead'>Examiner Evaluation Report Check Box</legend><div style='clear:both'><div class='rdo'>";
