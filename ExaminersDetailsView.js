...
function formExaminersDetailsView(dsp) {

		
		str = ""; 
		title = "Examiners Details View"; 
  
	if(dsp == "formExaminersDetailsView") {    

		
			str  = "<div id='formExaminersDetailsView'>";
				...
				str += '<h2 >'+title+'</h2><hr>';
					...
					str += '<form name="maintainformExaminersDetailsView"><br>';
						str +="<div>";
