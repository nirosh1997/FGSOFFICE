...
function formAppointExaminersDeptNomination(dsp) {
		str = "";
		title = "Appoint Examiners - Department Nomination";

		if(dsp == "formAppointExaminersDeptNomination") { 
			
			
			
			str  = "<div id='formAppointExaminersDeptNomination'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formAppointExaminersDeptNomination">';
			...
			str +="<div class='longIdentifier'>BOS No</div>";
			str +="<div class='viewArea'>";
		
			str +="<input type='text' name='BOS No' list='liststudentNIC' id='studentNIC' value= '"+dataRep["studentNIC"].trim()+"' onchange='dataRep[this.name]=this.value;setValuesProfile();'>";
			str += "<datalist id='liststudentNIC'>"+studentNICList+"</datalist>";
			str += "</div><br>";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>BOS Date</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>Date Received From head of Dept.</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			str += "<select name='commenceYYYY' value='commenceYYYY'  onchange='dataRep[this.name]=this.value;' class='dateSelect'>";
			str += generateNumberOptions(2015, 2025, 4, dataRep['commenceYYYY']);
			str += "</select>";
			str += "<select name='commenceMM' value='commenceMM' ' onchange='dataRep[this.name]=this.value;' class='dateSelect' >";
			...
			str += '<input type="button" class="btn" value = "Print Examiner List for BOS Recommendation" onclick = showMenu('+"' '"+');>';
