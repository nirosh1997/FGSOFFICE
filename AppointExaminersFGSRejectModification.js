...
function formAppointExaminersFGSRejectModification(dsp) {
		str = "";
		title = "Appoint Examiners - FGS Board Reject Modification";

		if(dsp == "formAppointExaminersFGSRejectModification") { 
