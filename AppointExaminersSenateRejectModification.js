...
function formAppointExaminersSenateRejectModification(dsp) {
		str = "";
		title = "Appoint Examiners - Senate Board Reject Modification";

		if(dsp == "formAppointExaminersSenateRejectModification") { 
			...
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formAppointExaminersFGSRejectModification">';
