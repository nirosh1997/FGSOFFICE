...
function formSendingThesisToExaminers(dsp) {
		str = "";
		title = "Sending Thesis To Examiners";

		if(dsp == "formSendingThesisToExaminers") { 
			
			
			
			str  = "<div id='formSendingThesisToExaminers'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formSendingThesisToExaminers">';
			...
			str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Degree Programme</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			...
			str +="<fieldset  class='field'><legend class='fieldHead'>Recommended Dates and Board No</legend><div style='clear:both'><div class='rdo'>";

			str +="<div style='margin-top:0px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Date of BOS Recommended</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div>";
			
			//str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Date of FGS Board Recommended</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div>";
			
			//str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>Date of Senate Recommended</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			
			str +="<div style='margin-top:5px;float:left;clear:both;'>";
			...
			//str +="<div style='margin-top:20px;float:left;clear:both;'>";
			str +="<div class='longIdentifier' style='clear:none;'>FGS Board No</div><div class='colon'>&nbsp;:&nbsp;</div>";
			str +="<div class='viewArea' style='clear:none;margin-right:100px;' id='studentName'>"+dataRep["studentName"]+"</div>";
			str +="<div class=hideLabel>&nbsp;</div>";
			str +="</div><br/>";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>Examiner 1 Sent Date</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>Examiner 2 Sent Date</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			str += "<select name='commenceYYYY' value='commenceYYYY'  onchange='dataRep[this.name]=this.value;' class='dateSelect'>";
			str += generateNumberOptions(2015, 2025, 4, dataRep['commenceYYYY']);
			str += "</select>";
			str += "<select name='commenceMM' value='commenceMM' ' onchange='dataRep[this.name]=this.value;' class='dateSelect' >";
			...
			str +="<div style='margin-top:20px;float:left;clear:both;' class = 'demoprint'>";
			str +="<div class='longIdentifier'>Examiner 3 Sent Date</div><div class='colon'>&nbsp;:&nbsp;</div><div style='float:left' >";
			str += "<select name='commenceYYYY' value='commenceYYYY'  onchange='dataRep[this.name]=this.value;' class='dateSelect'>";
			str += generateNumberOptions(2015, 2025, 4, dataRep['commenceYYYY']);
			str += "</select>";
			str += "<select name='commenceMM' value='commenceMM' ' onchange='dataRep[this.name]=this.value;' class='dateSelect' >";
			...
			str +="<input  type='checkbox' name='certifiedCertificates' class='changeColor' value= 'Birth Certificate'";
			str +=birthCertificateChecked;
			str +=" onclick='dataRep[this.name]=this.value;' /><label>Examiner 1 Inform By Call  </label>";
			str +="<input  type='checkbox' name='certifiedCertificates' class='changeColor' value= 'Degree Certificate/s'";
			str +=degreeCertificateChecked;
			str +=" onclick='dataRep[this.name]=this.value;' /><label>Examiner 2 Inform By Call  </label>";
			str +="<input  type='checkbox' name='certifiedCertificates' class='changeColor' value= 'Other'";
			str +=OtherChecked;
			str +=" onclick='dataRep[this.name]=this.value;' /><label>Examiner 3 Inform By Call</label></div>";
