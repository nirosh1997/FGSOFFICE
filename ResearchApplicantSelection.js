...
//------------------------------------------------------MAIN FUNCTION START---------------------------
function formApplicantResearchSelection(dsp) {
...
var registeredChecked = "";
		...
		str = "";
		title = "Research Applicants Selection";
		
		if(dsp == "formApplicantResearchSelection") {
...
//degreeTitleArr.sort();
			str  = "<div id='updateApplicantList'>";
				...
				str += '<input type="button"  class="btnB" id="search"  value="search" style="background-Color:#ff6633;" onclick=buttondisable11();serachApplicant1();>';
				str += "</div><br>";
			str += "<div>"
			...
			//	str += "Sinhala Medium<input type='checkbox' name='' id='SinhalaMedium' value='column one'/>";
				...
				str += "<class='longIdentifier'><div class='colon'></div><select id='selectedReDegreeName' onchange='dataRep[this.id]=this.selectedIndex;'>";
				str += programName;
				str += programName1;
				str += "</select>";	
				...
				str +="<div class='colon' style='width:100px;margin-left:10px;'>Academic Year</div><div class='colon'>&nbsp;:&nbsp;</div>";
				...
				//str +="<div  id='streamID' style='width:100px;margin-left:10px;'>";  
		
				str +="<div class='colon' style='width:100px;margin-left:10px;'><strong>Stream</strong></div><div class='colon'>&nbsp;:&nbsp;</div>";
				str += "<class='longIdentifier'><div class='colon'></div><select id='selectedStreamName' onchange='dataRep[this.id]=this.selectedIndex;'>";
				str += streamName;
				str += "</select>";	
		...
		//str +="<div class='colon'>";		
		str += '<input type="button" style="margin-top:1px;float:left" class="btnB" id="View-List" value="View List" onclick=filterResearchList();buttondisable11();>';
		str += '<input type="button" id="select-all" style="display:none;margin-top:1px;float:left" class="btnB" value="Mark All" onclick=SelectAllList1();>';
		str += '<input type="button" id="select-non" style="display:none;margin-top:1px;float:left" class="btnB" value="Unmark All" onclick=UnselectAllList1();>';
        //str +="</div >";
		...
		if (dataRep['roleName']=='Coordinator' || dataRep['roleName']=='Technical Coordinator')
		{
					str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='save' value='Save' disabled='disabled' onclick=formResearchApplicantListsendForm("+'"updateApplicantList"'+");formBulkNotesendForm1("+'"addBulkNotes"'+")>"; 
					
					str += '<input type="button" class="btnB" id="Download" value = "Download" disabled="disabled" style="margin-top:0px;width:157px;background-Color:#ff6633;padding-right:35px;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
		            str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:20px;height:30px;" id="Reset" value="Reset" disabled="disabled" onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+');sendForm('+"'data4ResearchcheckUserSelection'"+');sendForm('+"'data4ResearchcheckdepartmentSelection'"+');">';
					str += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formCoordinatorMenu'"+');>';
		...
		if (dataRep['roleName']=='Subject Clerk' || dataRep['roleName']=='FGS Deputy Registrar')
		{
		    ...
		    str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='reApplication' value='Remove Application' disabled='disabled' onclick=checkdeleteorsaveapplication1();CompleteApplication11();formDeleteApplicationsendForm1('deleteApplicationForm');>"; 
			
			str += '<input type="button" class="btnB"  id="Download" value = "Download" disabled="disabled" style="margin-top:0px;width:157px;background-Color:#ff6633;padding-right:35px;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
			
			str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='AddNote' value='Add Note' disabled='disabled' onclick=generateBulkNote1();>";            
		   
		   str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" id="Reset" value="Reset" disabled="disabled" onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
           
		   str += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formClerkMenu'"+');>';
            //str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="MAIL" onclick=sendMail1();>';
			str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="logout" onclick=logOut();>';
		...
		if (dataRep['roleName']=='Assistant Registrar')
		{
			...
			str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='AddNote' value='Add Note' disabled='disabled' onclick=generateBulkNote1();>";            
		    str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" id="Reset" value="Reset" disabled="disabled" onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
            str += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formAssistantRegistrarMenu'"+');>';
            //str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="MAIL" onclick=sendMail1();>';
			str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="logout" onclick=logOut();>';
		...
		{
			str += '<input type="button" class="btnB" id="Download" value = "Download" disabled="disabled" style="margin-top:0px;width:157px;background-Color:#ff6633;padding-right:35px;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
		    str += '<input type = "button" class ="btnB" id="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  value="Reset" disabled="disabled" onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
		    str += '<input type="button" class="btnB" value = "Return" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick = refresshStudentList1();showMenu('+"'formAdministratorMenu'"+');>';
            str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="logout" onclick=logOut();>';
		}
		if(dataRep['roleName']=='Dean')
		{
			// str += '<input type="button" class="btnB" id="Download" value = "Download" disabled="disabled" style="margin-top:0px;width:157px;background-Color:#ff6633;padding-right:35px;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
		    // str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" id="Reset" value="Reset" disabled="disabled"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+');sendForm('+"'data4ResearchcheckdepartmentSelection'"+');">';
		    // str += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formDeanMenu'"+');>';//width:157px;height:37px; Get Application List
            // str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="logout" onclick=logOut();>';
		// 
		str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='save' value='Save' disabled='disabled' onclick=formResearchApplicantListsendForm("+'"updateApplicantList"'+");formBulkNotesendForm1("+'"addBulkNotes"'+")>"; 
			...
			str += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='AddNote' value='Add Note' disabled='disabled' onclick=generateBulkNote1();>";            
		    str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" id="Reset" value="Reset" disabled="disabled" onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
            str += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formDeanMenu'"+');>';
            //str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="MAIL" onclick=sendMail1();>';
			str += '<input type = "button" class ="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value="logout" onclick=logOut();>';
...
function showStreamDive(){
	
	if(document.getElementById('selectedReDegreeName').value=='Master of Philosophy' || document.getElementById('selectedReDegreeName').value=='Doctor of Philosophy'){
	
	document.getElementById("streamID").style.display =  "";
...
function SelectAllList1() 
	{
		...
		if (applicationNoArr.indexOf(applicationNoArr[x]) == applicationNoArr.lastIndexOf(applicationNoArr[x]) || (applicationNoArr.indexOf(applicationNoArr[x]) != applicationNoArr.lastIndexOf(applicationNoArr[x]) && applicationNoArr.indexOf(applicationNoArr[x])==x)){
			...
			if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[x] & document.getElementById('achedamicYear').value==achedamicYearArr[x] & document.getElementById('selectedStreamName').value==streamNameArr[x] ){ //& document.getElementById('selectedStreamName').value==streamNameArr[x] 
			var nam="Alist";
				nam+=x;
			if (count==1)
		{
...
//------------------------------------------------------UPDATE SELECTED FUNCTION START---------------------------	
	function formResearchApplicantListsendForm(frm){
    ...
    if (confirm("Confirm Save!") == true) {
			...
			for(var i=0; i<applicationNoLength; i++){
				 if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[i]  & document.getElementById('achedamicYear').value==achedamicYearArr[i] & 
				 document.getElementById('selectedStreamName').value==streamNameArr[i]){ //
			    if(document.getElementById('checkSelected'+i)){
					if(document.getElementById('checkSelected'+i).checked == true )
					{
				if((document.getElementById('checkSelectedE'+i).checked==true || document.getElementById('checkSelectedP'+i).checked==true)){
					...
					else if(document.getElementById('checkSelectedE'+i).checked==true)
					{	
						newStr += "&selectionCategory="+"E";	
					}
					else if(document.getElementById('checkSelectedP'+i).checked==true)
					{	
...
//-----------------------------------------------------add Bulk Note--------------------------------
         	var checkNotes=0;
			for(var i=0; i<applicationNoLength; i++){
			if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[i]  & document.getElementById('achedamicYear').value==achedamicYearArr[i] & document.getElementById('selectedStreamName').value==streamNameArr[i]){ // 
			if(document.getElementById('checkSelected'+i)){
			if(document.getElementById('checkSelected'+i).checked == true){	  
		   ...
		   if(BulkNote!=" " || checkNotes !=0){
			...
			newStr1 += "&interface="+"addBulkNotes";			
				for(var i=0; i<applicationNoLength; i++){
				if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[i]  & document.getElementById('achedamicYear').value==achedamicYearArr[i] & document.getElementById('selectedStreamName').value==streamNameArr[i] ){ // & document.getElementById('selectedStreamName').value==streamNameArr[i] 
			    if(document.getElementById('checkSelected'+i)){
				if(document.getElementById('checkSelected'+i).checked == true){	
...
function formDeleteApplicationsendForm1(frm){
...
function CompleteApplication11(){
...
var count=1;
	...
	for( i=0; i<applicationNoLength; i++){
		if(applicationNoArr.indexOf(applicationNoArr[i]) == applicationNoArr.lastIndexOf(applicationNoArr[i]) || (applicationNoArr.indexOf(applicationNoArr[i]) != applicationNoArr.lastIndexOf(applicationNoArr[i]) && applicationNoArr.indexOf(applicationNoArr[i])==i)){
			if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[i] & document.getElementById('achedamicYear').value==achedamicYearArr[i] & document.getElementById('selectedStreamName').value==streamNameArr[i] ){// & (medium1Arr[i] == "en" )){  & document.getElementById('selectedStreamName').value==streamNameArr[i]	
              if(document.getElementById('checkSelected'+i)){
			   if(document.getElementById('checkSelected'+i).checked == true){
				   checkBoxCount++;
			   }
	...
	if(document.getElementById('selectedReDegreeName').value == "Please scroll down to see the records"){		
	alert("Please Select Programm and the Year.");
				  ...
				  var	newStr ="<div  id='inputs' style='margin:0px 10px;clear:both'>";
					...
					newStr +="<div class='investLabel' style='text-align:center;font-weight:bold;'>"+document.getElementById('selectedReDegreeName').value+"</div>";
					newStr +="<div class='investLabel' style='text-align:center;font-weight:bold;'>"+document.getElementById('achedamicYear').value+"</div>";
					newStr +="<div class='investLabel' style='text-align:center;font-weight:bold;'>"+document.getElementById('selectedStreamName').value+"</div>";
			...
			if(document.getElementById('selectedReDegreeName').value==degreeTitleArr[i] & document.getElementById('achedamicYear').value==achedamicYearArr[i] & document.getElementById('selectedStreamName').value==streamNameArr[i]){// & (medium1Arr[i] == "en" )){	 
			...
			//newStr+='<td  style="border:1px solid black;word-wrap:break-word;width:100px;heigth:30%;font-size:12px;font-family:tahoma;">'+educationValueArr[i]+'</td>';
	...
	// //	for(var i=0; i<applicationNoLength; i++){
            ...
            // if (educationFieldNameArr[i] !="Qualification" && educationFieldNameArr[i] !="Awarding Authority" && educationFieldNameArr[i] !="Awarding Year" && educationFieldNameArr[i] !="Country"){		
				...
				// {
				   ...
				   // newStr+='<td  style="border:none;width:300px;heigth:30%;font-size:18px;font-family:tahoma;font-weight:bold;">'+educationFieldNameArr[i]+'</td>';
				   // }
				  // //  for(var j=0; j<applicationNoLength; j++){
			        // if(dataRep["ApplicationNo"]==applicationNo1Arr[i]){
			        // if (educationPinArr.indexOf(educationPinArr[i]) == educationPinArr.lastIndexOf(educationPinArr[i]) || (educationPinArr.indexOf(educationPinArr[i]) != educationPinArr.lastIndexOf(educationPinArr[i]) && educationPinArr.indexOf(educationPinArr[i])==i)){
			        // if(educationFieldNameArr[i] !=undefined & educationFieldNameArr[i] !=" " & educationValueArr[i] !=undefined & educationValueArr[i] !=" "){		
			        // if (educationFieldNameArr[i] !="Qualification" || educationFieldNameArr[i] !="Awarding Authority" || educationFieldNameArr[i] !="Awarding Year" || educationFieldNameArr[i] !="Country"){	
				        // if(educationValueArr[i] !="" && educationFieldNameArr[i] == educationFieldNameArr[i]){
				           // newStr+='<td  style="border:none;width:300px;heigth:30%;font-size:18px;font-family:tahoma;word-wrap:break-word;">'+educationValueArr[i]+'&nbsp;</td>';
				        // }
...
function serachApplicant1()
{
	...
	if(document.getElementById('searchApplicantName').value!="" & document.getElementById('searchApplicant').value!=""){
		...
		viewStr +="<th style='width:30px;word-wrap:break-word;' align='center'><div class='investLabel' style='width:30px;word-wrap:break-word;'><font color='black'></font></div></th>";
		...
		viewStr +="<th style='width:100px;' align='center'><div class='investLabel' style='width:120px;' ><font color='black'>NIC</font></div></th>";
		viewStr +="<th style='width:150px;'align='center'><div class='investLabel_l' style='width:150px;word-wrap:break-word;'><font color='black'>Address</font></div></th>";
		viewStr +="<th style='width:100px;' align='center'><div class='investLabel' style='width:120px;'><font color='black'>Tel:No.</font></div></th>";
		viewStr +="<th style='width:100px;' align='center'><div class='investLabel' style='width:120px;'><font color='black'>Mobile No</font></div></th>";
		...
		viewStr +="<th style='width:40px;word-wrap:break-word;' align='center'><div class='investLabel' style='width:40px;word-wrap:break-word;'><font color='black'>Select</font></div></th>";
	
		//chinthaka
		viewStr +="<th style='width:100px;word-wrap:break-word;' align='center'><div class='investLabel' style='width:100px;word-wrap:break-word;'><font color='black'>Proposal Presentation</font></div></th>";
		viewStr +="<th style='width:100px;word-wrap:break-word;' align='center'><div class='investLabel' style='width:100px;word-wrap:break-word;'><font color='black'>Conditional Registration</font></div></th>";
		//chinthaka
		...
		if (applicationNoArr.indexOf(applicationNoArr[i]) == applicationNoArr.lastIndexOf(applicationNoArr[i]) || (applicationNoArr.indexOf(applicationNoArr[i]) != applicationNoArr.lastIndexOf(applicationNoArr[i]) && applicationNoArr.indexOf(applicationNoArr[i])==i)){
		    ...
		    if(count%2==0){
			viewStr += '<button  style="width:250px;text-align:left;background-Color:#ffece6;font-size:12px;" id="Namebtn'+i+'" onclick="loadProfile1(this);">'+studentInitialArr[i]+'</button></div></td>';//sendForm('+"data4StudentProfileDeteilsCheckUser"+');
			}
			else{
			viewStr += '<button  style="width:250px;text-align:left;background-Color:#ffd9cc;font-size:12px;" id="Namebtn'+i+'" onclick="loadProfile1(this);">'+studentInitialArr[i]+'</button></div></td>';//sendForm('+"data4StudentProfileDeteilsCheckUser"+');
			}
			...
			viewStr += "<td style='width:80px;word-wrap:break-word' align='center'><div class='investView' style='width:100px;' name='studentNIC"+i+"' id='studentNIC"+i+"'";
            ...
            viewStr += "<td style='width:80px;word-wrap:break-word' align='center'><div class='investView' style='width:100px;' name='TelNo"+i+"' id='TelNo"+i+"'";
			viewStr += " onchange='dataRep[this.name]=this.value;'>"+studentContactLanArr[i]+"</div></td>";				
			
			viewStr += "<td style='width:80px;word-wrap:break-word' align='center'><div class='investView' style='width:100px;' name='MobNo"+i+"' id='MobNo"+i+"'";
			...
			viewStr += "<input type='checkbox' "+selectedChecked+"  id='checkSelected"+i+"' onChange='AddRowColor1("+i+", this)' name='checkSelected"+i+"''/>";
			viewStr += "</div></td>";
			
			//chinthaka
			
			viewStr += "<td style='width:30px;word-wrap:break-word' align='center'><div style='width:30px;' class='investView' name='selected"+i+"' id='selected"+i+"'>"; //Alist"+i+"
			viewStr += "<input type='checkbox' "+selectedCheckedE+"  id='checkSelectedE"+i+"' onChange='AddRowColor1("+i+", this)' name='checkSelectedE"+i+"''/>";
			viewStr += "</div></td>";
			
			viewStr += "<td style='width:30px;word-wrap:break-word' align='center'><div style='width:30px;' class='investView' name='selected"+i+"' id='selected"+i+"'>"; //Alist"+i+"
			viewStr += "<input type='checkbox' "+selectedCheckedP+"  id='checkSelectedP"+i+"' onChange='AddRowColor1("+i+", this)' name='checkSelectedP"+i+"''/>";
			viewStr += "</div></td>";
			
			//chinthaka
			
			viewStr += "<td style='width:40px;word-wrap:break-word'><div style='width:30px;' class='investView'><input type='button' name='notesBttn"+i+"' id='notesBttn"+i+"' style='margin-top:0px' value='+' onclick='generateNotes1(this);dataRep[this.name]=this.value; '>";
	...
	if (count >=6)
	{
		...
		if (dataRep['roleName']=='Coordinator' || dataRep['roleName']=='Technical Coordinator')
		{
			...
			var viewStr1 = "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='save' value='Save' disabled='disabled' onclick=formResearchApplicantListsendForm("+'"updateApplicantList"'+");formBulkNotesendForm1("+'"addBulkNotes"'+")>"; 
			
			viewStr1 += '<input type="button" class="btnB"  id="Download" value = "Download"  style="margin-top:0px;padding-right:35px;width:157px;background-Color:#ff6633;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
            viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+');sendForm('+"'data4ResearchcheckUserSelection'"+');sendForm('+"'data4ResearchcheckdepartmentSelection'"+');">';
			viewStr1 += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formCoordinatorMenu'"+');>';
		...
		if (dataRep['roleName']=='Subject Clerk' || dataRep['roleName']=='FGS Deputy Registrar')
		{
			var viewStr1 = "<input type='button' class='btnB' id='save' value='Save' style='background-Color:#ff6633;padding-right:20px;height:30px;' onclick=formResearchApplicantListsendForm("+'"updateApplicantList"'+");formBulkNotesendForm1("+'"addBulkNotes"'+")>"; 
		
		    viewStr1 += "<input type='button' class='btnB' id='reApplication' style='background-Color:#ff6633;padding-right:20px;height:30px;' value='Remove Application' onclick=formDeleteApplicationsendForm1('deleteApplicationForm');>"; 
			viewStr1 += '<input type="button" class="btnB"  id="Download" value = "Download"  style="margin-top:0px;padding-right:35px;width:157px;background-Color:#ff6633;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
 			viewStr1 += "<input type='button' class='btnB' style='background-Color:#ff6633;padding-right:20px;height:30px;' id='AddNote' value='Add Note' onclick=generateBulkNote1();>";            
           
			viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
            viewStr1 += '<input type="button" class="btnB" value = "Return" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick = refresshStudentList1();showMenu('+"'formClerkMenu'"+');>';
            viewStr1 += '<input type = "button" class ="btnB" value="logout" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick=logOut();>';
		...
		if (dataRep['roleName']=='Assistant Registrar')
		{
			...
			viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
            viewStr1 += '<input type="button" class="btnB" value = "Return" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick = refresshStudentList1();showMenu('+"'formAssistantRegistrarMenu'"+');>';
            viewStr1 += '<input type = "button" class ="btnB" value="logout" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick=logOut();>';
		...
		if(dataRep['roleName']=='Administrator')
		{
			var viewStr1 = '<input type="button" class="btnB"  id="Download" value = "Download"  style="margin-top:0px;padding-right:35px;width:157px;background-Color:#ff6633;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
            viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+')">';
		    viewStr1 += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formAdministratorMenu'"+');>';
            viewStr1 += '<input type = "button" class ="btnB" value="logout" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick=logOut();>';
		}
		if(dataRep['roleName']=='Dean')
		{
			var viewStr1 = '<input type="button" class="btnB"  id="Download" value = "Download"  style="margin-top:0px;padding-right:35px;width:157px;background-Color:#ff6633;height:30px;" onclick = CompleteApplication1();><img style="background-Color:#ff6633;margin-left:-32px;margin-bottom:-9px;height:25px;" src="img/DownloadImg.png"/></input>';
            viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ResearchApplicantSelection'"+');sendForm('+"'data4ResearchcheckdepartmentSelection'"+');">';
		    viewStr1 += '<input type="button" class="btnB" style="background-Color:#ff6633;padding-right:20px;height:30px;" value = "Return" onclick = refresshStudentList1();showMenu('+"'formDeanMenu'"+');>';//width:157px;height:37px; Get Application List
            viewStr1 += '<input type = "button" class ="btnB" value="logout" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick=logOut();>';
		}
...
for( var i=0; i<applicationNoLength; i++){
	if (applicationNoArr.indexOf(applicationNoArr[i]) == applicationNoArr.lastIndexOf(applicationNoArr[i]) || (applicationNoArr.indexOf(applicationNoArr[i]) != applicationNoArr.lastIndexOf(applicationNoArr[i]) && applicationNoArr.indexOf(applicationNoArr[i])==i)){
		...
		// else if(document.getElementById('selectedReDegreeName').value=='Master of Philosophy' || document.getElementById('selectedReDegreeName').value=='Doctor of Philosophy' & document.getElementById('achedamicYear').value==achedamicYearArr[i] ){
...
if(rowCount==0)
{
	alert('There is no data');
	  ...
	  countviewList++;
	    var viewStr ="<table id='myTable' style='margin-left:20px;border-collapse:separate;border-spacing:2px 0;'>";
		viewStr +="<tr style='background-Color:#ff9f80'>";
		viewStr +="<th style='width:20px;padding-right:10px;'><div style='width:30px;'></div></th>";
		viewStr +="<th style='width:250px;fontColor:white' align='center'><div class='investLabel_l' style='width:250px;'><font color='black'>Applicant Name</font></div></th>";
		viewStr +="<th style='width:150px;' align='center'><div class='investLabel' style='width:150px;'><font color='black'>Application No</font></div></th>";
		viewStr +="<th style='width:100px;' align='center'><div class='investLabel' style='width:120px;' ><font color='black'>NIC</font></div></th>";
		viewStr +="<th style='width:150px;' align='center'><div class='investLabel_l' style='width:150px;word-wrap:break-word;'><font color='black'>Address</font></div></th>";
	...
	if (count >=6)
	{
		...
		if (dataRep['roleName']=='Subject Clerk' || dataRep['roleName']=='FGS Deputy Registrar')
		{
			...
			viewStr1 += '<input type = "button" class ="btnB" id="Reset" value="Reset" style="background-Color:#ff6633;padding-right:20px;height:30px;"  onclick="refresshStudentList1();sendForm('+"'data4ApplicantSelectiont'"+')">';
            viewStr1 += '<input type="button" class="btnB" value = "Return" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick = refresshStudentList1();showMenu('+"'formClerkMenu'"+');>';
            viewStr1 += '<input type = "button" class ="btnB" value="logout" style="background-Color:#ff6633;padding-right:20px;height:30px;" onclick=logOut();>';
...
function loadProfile1(app)
{
	...
	sendForm('data4GetReleventApplicantSelection');
	sendForm('data4StudentProfileDeteilsCheckUserSelection');	
	sendForm('data4profileEducationalDetailsSelection');
	setValuesProfileabc();	*/
