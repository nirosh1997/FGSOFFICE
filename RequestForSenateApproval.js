...
function formRequestForSenateApproval(dsp) {
		str = "";
		title = "Request For Senate Approval";

		if(dsp == "formRequestForSenateApproval") { 
			
			
			
			str  = "<div id='formRequestForSenateApproval'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formRequestForSenateApproval">';
			...
			str += '<input type="button" class="btn" value = "Senate Approved" onclick = showMenu('+"' '"+');>';
			str += '<input type="button" class="btn" value = "Senate Rejected" onclick = showMenu('+"'formAppointExaminersSenateRejectModification'"+');>';
