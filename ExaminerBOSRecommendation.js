...
function formExaminerBOSRecommendation(dsp) {
		str = "";
		title = "Appoint Examiners - BOS Recommendation";

		if(dsp == "formExaminerBOSRecommendation") { 
			
			
			
			str  = "<div id='formExaminerBOSRecommendation'  >";
			str += "<table align='center' border='1'><tr><td>"
			str += '<h2>'+title+'</h2><hr>';
			str += '<form name="formExaminerBOSRecommendation">';
