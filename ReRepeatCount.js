function formDownloadReRepeatCount(dsp) {

	str = ""; 
	title = ""; 
  
	if(dsp == "formDownloadReRepeatCount") {    
		str  = "<div id='formDownloadReRepeatCount'>";	
		str += "<table><tr><td>";
		str += '<h2 >'+title+'</h2><hr>';
		str += '<form id="formDownloadReRepeatCount"><br>';
		str +="<div>";	
		
		str += "<div style='clear:both'>";
		str += '<input type="button" id="gtPrint" class="btnD" value="Download List"  onclick= "DownloadReRepeatList();" >';
